...
import { initRelationships }   from "./sections/relationships.js"; // διόρθωση: εισαγωγή της init
// --------------------------------------------------
...
// ΔΙΟΡΘΩΣΗ: σωστό ID στο HTML είναι "genealogy"
...
async function loadForEdit() {
  ...
  genealogyInput.value  = data.genealogy   || "";  // ΔΙΟΡΘΩΣΗ: σωστή κλήση
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  initBurialSection();
  initRelationships();         // <— κλήση της initRelationships
  attachDeleteListeners();
});
